...
if __name__ == "__main__":
  ...
  dataset_args_all = {
    "ac_beach_set_of_eight_basic_encoding": {
      "paths": [
      ...
      "encoding_config": "basic"
    },
    "ac_beach_set_of_three_basic_encoding": {
      "paths": [
        '/shed/photo/export/atlantic_city_thanksgiving_nov2020/album/0008_DSC08949.png',
        '/shed/photo/export/atlantic_city_thanksgiving_nov2020/album/0010_DSC09041.png',
        '/shed/photo/export/atlantic_city_thanksgiving_nov2020/album/0011_DSC09073.png',
  ...
  copy_keys = [
      ("ac_beach_set_of_eight_basic_encoding", "ac_beach_set_of_eight_bigger_head_basic_encoding"),
      ("ac_beach_set_of_eight_basic_encoding", "ac_beach_set_of_eight_bigger_model_basic_encoding"),
  ]
  ...
  hidden_unit_dict = {
    "ac_beach_set_of_eight_basic_encoding": ([256] * 2, [256] * 3),
    "ac_beach_set_of_eight_bigger_head_basic_encoding": ([256] * 3, [256] * 2),
    "ac_beach_set_of_eight_bigger_model_basic_encoding": ([256] * 3, [256] * 4),
    "ac_beach_set_of_three_basic_encoding": ([256] * 2, [256] * 3),
